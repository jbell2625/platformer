...
# Fonts
FONT_SM = pygame.font.Font("assets/fonts/zakenstein.ttf", 32)
FONT_MD = pygame.font.Font("assets/fonts/zakenstein.ttf", 64)
FONT_LG = pygame.font.Font("assets/fonts/Pozo.ttf", 72)
...
block_images = {"TL1": load_image("assets/tiles/top_left1.png"),
                "TM1": load_image("assets/tiles/top_middle1.png"),
                "TR1": load_image("assets/tiles/top_right1.png"),
                "ER1": load_image("assets/tiles/end_right1.png"),
                "EL1": load_image("assets/tiles/end_left1.png"),
                "TP1": load_image("assets/tiles/top1.png"),
                "CN1": load_image("assets/tiles/center1.png"),
                "LF1": load_image("assets/tiles/lone_float1.png"),
                "SP1": load_image("assets/tiles/special1.png"),
...
health_img = load_image("assets/items/vapefull.png")
empty_health_img = load_image("assets/items/vapeempty.png")
...
class Character(Entity):
    ...
    def check_flag(self, level):
        ...
        if len(hit_list) > 0:
            ...
            self.score += (level.time_remaining // FPS) * 2
...
class Game():
    ...
    def display_stats(self, surface):
        ...
        time_text = FONT_SM.render("Time: " + str(self.level.time_remaining //60), 1, WHITE)

        surface.blit(score_text, (WIDTH - score_text.get_width() - 32, 32))
        surface.blit(hearts_text, (32, 32))
        surface.blit(lives_text, (32, 64))
        surface.blit(time_text, (WIDTH - time_text.get_width() -32, 60))

        for x in range(self.hero.max_hearts):
            if x < self.hero.hearts:
                surface.blit(health_img, [x * 25, y])

            else:
                surface.blit(empty_health_img, [x * 25, y])
